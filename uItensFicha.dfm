object fItensFicha: TfItensFicha
  Left = 186
  Top = 141
  ...
  object PageControl1: TPageControl
    ...
    Width = 688
    Height = 177
    ActivePage = sheetComercio
    Align = alClient
    TabIndex = 2
    TabOrder = 0
    object sheetDiretor: TTabSheet
      Caption = 'Diretores/Propret'#225'rio'
    ...
    object sheetComercio: TTabSheet
  ...
  object dsDiretor: TDataSource
    DataSet = DM.Diretor
    OnStateChange = dsDiretorStateChange
    Left = 144
    Top = 24
  end
  object dsRefBanco: TDataSource
    DataSet = DM.RefBanco
    OnStateChange = dsRefBancoStateChange
    Left = 200
    Top = 24
  end
  object dsRefComercio: TDataSource
    DataSet = DM.RefComercio
    OnStateChange = dsRefComercioStateChange
    Left = 272
    Top = 24
  end
