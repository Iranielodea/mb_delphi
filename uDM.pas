   ...
   begin
      ...
      begin
        if dm.PedidoPERC_COMISSAO.AsCurrency > 0 then
          sTemp := sTemp + 'COMISSÃO DE ' + DM.PedidoPERC_COMISSAO.AsString + '%';
...
begin
   ...
   CargaOBS2.AsString := '"AÇUCAR ADIQUIRIDO DA EMPRESA CANEX LTDA"';
...
begin
   try
      ...
      begin
         showMessage('Erro: duplicação de Registro');
         exit;
      end;
