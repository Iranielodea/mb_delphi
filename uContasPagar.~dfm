object fContasPagar: TfContasPagar
  ...
  object Contas: TClientDataSet
    ...
    object ContasC_TOTAL_RECEBER: TAggregateField
      Alignment = taRightJustify
      FieldName = 'C_TOTAL_RECEBER'
      Active = True
      DisplayFormat = ',##0.00'
      Expression = 'sum(VALOR_PAGAR)'
    end
    object ContasC_TOTAL_PAGO: TAggregateField
      Alignment = taRightJustify
      FieldName = 'C_TOTAL_PAGO'
      Active = True
      DisplayFormat = ',##0.00'
  ...
  object QDoc: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '   PES.NOME'
      'from CONTAS CON'
      '   inner join FORNECEDOR PES on CON.COD_FOR = PES.COD_FOR'
      '   where CON.TIPO_CONTA = 3'
      '   and CON.DOCUMENTO = :DOCUMENTO'
      '   order by CON.COD_FOR')
    Left = 320
    Top = 192
    object QDocDOCUMENTO: TStringField
      FieldName = 'DOCUMENTO'
    end
    object QDocCOD_FOR: TIntegerField
      FieldName = 'COD_FOR'
    end
    object QDocNOME: TStringField
      FieldName = 'NOME'
      Required = True
      Size = 60
    end
