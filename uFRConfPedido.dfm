object FRConfPedido: TFRConfPedido
  Left = 0
  Top = 0
  Caption = 'FRConfPedido'
  ClientHeight = 161
  ClientWidth = 289
  Color = clBtnFace
  ...
  object QPedido: TSQLQuery
    ...
    SQL.Strings = (
      ...
      '   UNI.SIGLA         AS ITE_UN,'
      '   ITE.preco_venda - ITE.valor AS ITE_VALOR_UNIT,'
      
        '   ITE.qtde * (ITE.preco_venda - ITE.valor) AS ITE_VALOR_TOTAL_U' +
        'NIT,'
      ''
      '   CONF.frete_pago_descarga AS CONF_FRETE_PAGO_DESC,'
      '   CONF.com_manifesto AS CONF_COM_MANIFESTO,'
      '   CONF.com_descarga AS CONF_COM_DESCARGA,'
      '   CONF.texto AS CONF_TEXTO,'
      '   CONF.vencimento AS CONF_VENCIMENTOS,'
      '   CONF.prazo AS CONF_PRAZO,'
      ''
      '    forn.cod_for AS for_codigo,'
      '    forn.nome AS for_nome,'
      '    forn.cnpj AS for_cnpj,'
      '    forn.insc_estadual AS for_insc_estadual,'
      '    forn.endereco AS for_endereco,'
      
        '    COALESCE(cid_for.desc_cidade , '#39#39') ||'#39' - '#39' || COALESCE(est_f' +
        'or.sigla, '#39#39') as for_cidade_uf,'
      '    forn.cep AS for_cep,'
      '    forn.fone AS for_fone,'
      '    forn.email AS for_email,'
      '    forn.bairro AS for_bairro,'
      '    cid_for.desc_cidade AS for_cidade,'
      '    est_for.sigla AS for_UF'
      ''
      'from PEDIDO PED'
        ...
        '   inner join conf_pedido CONF   on CONF.num_pedido = PED.num_pe' +
        'dido'
        ...
        'ADE'
      ''
      '   left join FORNECEDOR FORN     on PED.COD_FOR = FORN.COD_FOR'
      
        '   LEFT JOIN cidade cid_For      ON forn.cod_cidade = cid_for.co' +
        'd_cidade'
      
        '   LEFT JOIN estado est_for      ON cid_for.id_estado = est_for.' +
        'id_estado'
  ...
  object cdsPedido: TClientDataSet
    ...
    Left = 144
    Top = 24
    object cdsPedidoEMP_NOME: TStringField
      FieldName = 'EMP_NOME'
      Required = True
      Size = 60
    end
    object cdsPedidoEMP_ENDERECO: TStringField
      FieldName = 'EMP_ENDERECO'
      Size = 50
    end
    object cdsPedidoEMP_NUMERO: TStringField
      FieldName = 'EMP_NUMERO'
      Size = 8
    end
    object cdsPedidoEMP_CEP: TStringField
      FieldName = 'EMP_CEP'
      FixedChar = True
      Size = 8
    end
    object cdsPedidoEMP_DESC_CIDADE: TStringField
      FieldName = 'EMP_DESC_CIDADE'
      Size = 40
    end
    object cdsPedidoEMP_ESTADO: TStringField
      FieldName = 'EMP_ESTADO'
      FixedChar = True
      Size = 2
    end
    object cdsPedidoEMP_FONE: TStringField
      FieldName = 'EMP_FONE'
      Size = 15
    end
    object cdsPedidoEMP_FAX: TStringField
      FieldName = 'EMP_FAX'
      Size = 15
    end
    object cdsPedidoEMP_EMAIL: TStringField
      FieldName = 'EMP_EMAIL'
      Size = 80
    end
    object cdsPedidoEMP_CNPJ: TStringField
      FieldName = 'EMP_CNPJ'
      Size = 14
    end
    object cdsPedidoPED_NUM_PEDIDO: TIntegerField
      FieldName = 'PED_NUM_PEDIDO'
      Required = True
    end
    object cdsPedidoPED_DATA: TSQLTimeStampField
      FieldName = 'PED_DATA'
      Required = True
    end
    object cdsPedidoPED_OBS: TStringField
      FieldName = 'PED_OBS'
      Size = 200
    end
    object cdsPedidoPED_TOTAL_LIQUIDO: TFloatField
      FieldName = 'PED_TOTAL_LIQUIDO'
    end
    object cdsPedidoCLI_NOME: TStringField
      FieldName = 'CLI_NOME'
      Size = 60
    end
    object cdsPedidoCLI_ENDERECO: TStringField
      FieldName = 'CLI_ENDERECO'
      Size = 50
    end
    object cdsPedidoCLI_BAIRRO: TStringField
      FieldName = 'CLI_BAIRRO'
      Size = 40
    end
    object cdsPedidoCLI_NUMERO: TStringField
      FieldName = 'CLI_NUMERO'
      Size = 8
    end
    object cdsPedidoCLI_CEP: TStringField
      FieldName = 'CLI_CEP'
      FixedChar = True
      Size = 8
    end
    object cdsPedidoCLI_COMPLEMENTO: TStringField
      FieldName = 'CLI_COMPLEMENTO'
      Size = 30
    end
    object cdsPedidoCLI_CNPJ: TStringField
      FieldName = 'CLI_CNPJ'
      Size = 14
    end
    object cdsPedidoCLI_INSC_ESTADUAL: TStringField
      FieldName = 'CLI_INSC_ESTADUAL'
    end
    object cdsPedidoCLI_EMAIL: TStringField
      FieldName = 'CLI_EMAIL'
      Size = 500
    end
    object cdsPedidoCLI_DESC_CIDADE: TStringField
    ...
    object cdsPedidoITE_DESC_PRODUTO: TStringField
      FieldName = 'ITE_DESC_PRODUTO'
      Size = 50
    end
    object cdsPedidoITE_QTDE: TFloatField
      FieldName = 'ITE_QTDE'
    end
    object cdsPedidoITE_VALOR: TFloatField
      FieldName = 'ITE_VALOR'
    end
    object cdsPedidoITE_VALOR_TOTAL: TFloatField
      FieldName = 'ITE_VALOR_TOTAL'
    end
    object cdsPedidoITE_UN: TStringField
      FieldName = 'ITE_UN'
      FixedChar = True
      Size = 5
    end
    object cdsPedidoCONF_FRETE_PAGO_DESC: TStringField
      FieldName = 'CONF_FRETE_PAGO_DESC'
      FixedChar = True
      Size = 1
    end
    object cdsPedidoCONF_COM_MANIFESTO: TStringField
      FieldName = 'CONF_COM_MANIFESTO'
      FixedChar = True
      Size = 1
    end
    object cdsPedidoCONF_COM_DESCARGA: TStringField
      FieldName = 'CONF_COM_DESCARGA'
      FixedChar = True
      Size = 1
    end
    object cdsPedidoCONF_TEXTO: TStringField
      FieldName = 'CONF_TEXTO'
      Size = 500
    end
    object cdsPedidoCONF_VENCIMENTOS: TStringField
      FieldName = 'CONF_VENCIMENTOS'
      Size = 100
    end
    object cdsPedidoCONF_PRAZO: TStringField
      FieldName = 'CONF_PRAZO'
      Size = 30
    end
    object cdsPedidoITE_VALOR_UNIT: TFloatField
      FieldName = 'ITE_VALOR_UNIT'
    end
    object cdsPedidoITE_VALOR_TOTAL_UNIT: TFloatField
      FieldName = 'ITE_VALOR_TOTAL_UNIT'
    end
    object cdsPedidoFOR_CODIGO: TIntegerField
      FieldName = 'FOR_CODIGO'
    end
    object cdsPedidoFOR_NOME: TStringField
      FieldName = 'FOR_NOME'
      Size = 60
    end
    object cdsPedidoFOR_CNPJ: TStringField
      FieldName = 'FOR_CNPJ'
      Size = 14
    end
    object cdsPedidoFOR_ENDERECO: TStringField
      FieldName = 'FOR_ENDERECO'
      Size = 50
    end
    object cdsPedidoFOR_CIDADE_UF: TStringField
      FieldName = 'FOR_CIDADE_UF'
      Size = 55
    end
    object cdsPedidoFOR_CEP: TStringField
      FieldName = 'FOR_CEP'
      FixedChar = True
      Size = 8
    end
    object cdsPedidoFOR_FONE: TStringField
      FieldName = 'FOR_FONE'
      Size = 15
    end
    object cdsPedidoFOR_EMAIL: TStringField
      FieldName = 'FOR_EMAIL'
      Size = 80
    end
    object cdsPedidoFOR_BAIRRO: TStringField
      FieldName = 'FOR_BAIRRO'
      Size = 40
    end
    object cdsPedidoFOR_CIDADE: TStringField
      FieldName = 'FOR_CIDADE'
      Size = 50
    end
    object cdsPedidoFOR_UF: TStringField
      FieldName = 'FOR_UF'
      FixedChar = True
      Size = 2
    end
    object cdsPedidoFOR_INSC_ESTADUAL: TStringField
      FieldName = 'FOR_INSC_ESTADUAL'
    end
  end
  ...
  object RelPedido: TppReport
    ...
    Template.FileName = 'C:\Projetos\mb\Confirmacao.rtm'
    Units = utMillimeters
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel30: TppLabel
        UserName = 'Label30'
        Caption = '- Representa'#231#245'es Comerciais Ltda.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel33: TppLabel
        UserName = 'Label33'
        Caption = 'Rua: Borges de Medeiros, 1771 - Sala 25'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel35: TppLabel
        UserName = 'Label35'
        Caption = '95270-000 - Flores da Cunha - RS'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel36: TppLabel
        UserName = 'Label36'
        Caption = 'e-mail: comercial@biazusacucar.com.br'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel37: TppLabel
        UserName = 'Label37'
        Caption = 'Fone: 54-3292.2442 / 3967 / 9551'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel2: TppLabel
        UserName = 'Label2'
        Caption = 'Confirma'#231#227'o do Pedido N'#186':'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 16
      ...
      object ppLabel3: TppLabel
        UserName = 'Label3'
        Caption = 'Enviar Confirma'#231#227'o. Ap'#243's carimbar e assinar para:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Name = 'Arial'
        Font.Size = 10
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object ppLabel12: TppLabel
        UserName = 'Label12'
        Caption = 'Frete Pago na Descarga'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object myDBCheckBox1: TmyDBCheckBox
        ...
        BooleanTrue = 'S'
        DataPipeline = dbPedido
        DataField = 'CONF_FRETE_PAGO_DESC'
        DataPipelineName = 'dbPedido'
        mmHeight = 6350
        mmLeft = 15346
        mmTop = 4233
