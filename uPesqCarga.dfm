object fPesqCarga: TfPesqCarga
  ...
  object Panel3: TPanel
    ...
    object Label7: TLabel
      ...
      Height = 33
      AutoSize = False
      Caption = 'Bot'#227'o Direito para Pedido'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
  ...
  object SQLDataSet1: TSQLDataSet
    CommandText = 
      'select DATA, LETRA, NUM_CARGA, ID_CARGA, QTDE, VALOR_FRETE'#13#10',QTD' +
      'E_PEDIDO, QTDE'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.BancoDados
