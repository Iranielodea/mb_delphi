object fIMotorista: TfIMotorista
  Left = 192
  Top = 114
  Width = 652
  Height = 290
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Relat'#243'rio de Motoristas'
  Color = clBtnFace
  ...
  object Label6: TLabel
    ...
    Width = 106
    Height = 16
    Caption = 'Tonelagem Final'
  end
  object GrRelatorio: TGroupBox
    Left = 16
    Top = 32
    Width = 137
    Height = 105
